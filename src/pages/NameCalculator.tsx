    ...
    "@graph": [
      ...
      },
      {
        ...
        mainEntity: [
          {
            "@type": "Question",
            name: "Is this a truly scientific or accurate result?",
            acceptedAnswer: {
              "@type": "Answer",
              text: "No. The SkarLove Love Calculator is for entertainment only. The percentage is calculated based on a proprietary, non-scientific name-matching algorithm.",
            },
          },
          {
            "@type": "Question",
            name: "Do you store the names and data I enter?",
            acceptedAnswer: {
              "@type": "Answer",
              text: "No. For your privacy, the names are processed instantly to generate the result and are never stored, logged, or shared.",
            },
          },
          {
            "@type": "Question",
            name: "What determines the percentage score?",
            acceptedAnswer: {
              "@type": "Answer",
              text: "Our score is generated by an algorithm that analyzes the letter frequency, numerical values, and vibrational compatibility of the two names.",
            },
          },
        ],
      },
      ...
      <main className="container py-12 flex-grow">
        <article>
          ...
          <section className="mx-auto mb-8 max-w-3xl text-muted-foreground prose prose-sm">
            <p>
              Enter your partner name below to instantly calculate a love
              percentage between you.Results are generated on the fly — no
              sign-up or personal data required — and you can download or share
              a visually pleasing result card if you want to save or post the
              outcome. Use the love percentage as a playful conversation starter
              or a quick, light-hearted way to explore name-based compatibility.
              While the percentage gives an easy-to-understand snapshot,
              remember this tool is for entertainment: true relationship
              compatibility depends on many real-world factors beyond any
              name-based score. We prioritize privacy (names aren’t stored
              permanently).
            </p>
          </section>
